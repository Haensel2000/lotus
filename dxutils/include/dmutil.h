...
//-----------------------------------------------------------------------------
// inline void SetVol(long Volume = 0) added to CMusicSegment-Class
//-----------------------------------------------------------------------------
...
public:
    ...
    inline void SetVol(long Volume = 0)
    {
        m_pPerformance->SetGlobalParam( GUID_PerfMasterVolume, (void*)&Volume, sizeof(long) );      
    }
